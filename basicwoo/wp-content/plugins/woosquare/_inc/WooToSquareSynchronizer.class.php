	...
	public function uploadImage($product_square_id, $image_file, $product_woo_id) {
		...
		if($fileContents) {
			...
			if ( is_object( $decoded_response ) &&
				...
				$oauth_connect_url = 'http://connect.apiexperts.io';
				...
				$this->square->setAccessToken(sanitize_text_field($decoded_oauth_response->access_token));
				$this->uploadImage($product_square_id, $image_file, $product_woo_id);
			}
